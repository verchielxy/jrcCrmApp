...
const apiVersion = '/api/v1/buildOrderCheck';

const materialApplyApi = {
	...
	customers(page, size, searchParams) {
		return request({
			url: serverUrl + apiVersion + '/customList',
			method: 'get',
			data: {
				pageNo: page,
				pageSize: size,
...
export default materialApplyApi;
